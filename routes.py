...
from web.joinhour import activity_handler, home_request_handler, join_handler, thank_you_handler, \
    ...
    about_handler, propmanagers_handler, pre_register_handler, cancel_activity_handler, landing_handler
...
_routes = [
    ...
    RedirectRoute('/landing/', landing_handler.LandingHandler, name='landing', strict_slash=True),
